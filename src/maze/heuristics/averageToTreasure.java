...
public class averageToTreasure implements ToIntFunction<MazeExplorer> {
// switch to average of the ToTreasure algorithms
    // is this monotonic
    @Override
    ...
    public int man(MazeExplorer value) {
    ...
    public int pyth(MazeExplorer value) {
